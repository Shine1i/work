...
export const applicationProcessTypeEnum = pgEnum("application_process_type_enum", [
  "quick_apply",
  "standard_ats",
  "complex_ats",
]);
...
export const jobRuns = pgTable(
  ...
  (table) => [
    uniqueIndex("ix_job_runs_single_running")
      .using("btree", table.status.asc().nullsLast().op("enum_ops"))
      .where(sql`(status = 'running'::job_status_enum)`),
