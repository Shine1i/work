...
export const companySizeEnum = pgEnum("company_size_enum", ['startup', 'small', 'medium', 'large', 'unknown'])
...
export const growthPotentialEnum = pgEnum("growth_potential_enum", ['high', 'medium', 'low'])
export const interactionLevelEnum = pgEnum("interaction_level_enum", ['low', 'medium', 'high'])
export const jobStatusEnum = pgEnum("job_status_enum", ['pending', 'running', 'completed', 'failed', 'stopped'])
export const languageLevelEnum = pgEnum("language_level_enum", ['swedish_required', 'english_sufficient', 'bilingual_preferred'])
